...
@section('content')
    ...
    <div class="w-full flex flex-col md:flex-row">
        ...
        <div class="w-full md:w-1/3 mx-auto order-2 md:order-3">
            ...
            <div class="w-full md:w-11/12 border-2 border-gray-300 rounded-md shadow md:text-lg pt-6">
                ...
                @endif
                <form action="/add-many" method="GET" class="fixed bottom-0 md:static bg-white py-5 w-full flex justify-center items-center my-5">
